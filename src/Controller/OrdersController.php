...
use App\Repository\OrderStatesRepository;
...
class OrdersController extends AbstractController
{
     ...
     */
    public function new(Request $request, EntityManagerInterface $entityManager, OrderStatesRepository $orderStatesRepository): Response
    {
        $order = new Orders();
        //default values
        $order->setDatecreate(new \DateTime());
        $order->setStates($orderStatesRepository->find(1));
